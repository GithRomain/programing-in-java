...
/**
 * <p>Queues typically, but not necessarily (e.g., priority queues),
 ...
 * otherwise returns {@code false}. This differs from the {@link
 * java.util.Collection#add Collection.add()} method, which can fail to
 * add an element only by throwing an unchecked exception.
 * The {@code offer} method is designed for use when failure is a normal,
...
public class Main {
    ...
    /** Deque: adding/removing elements to the beginning */
    ...
    /** Deque: adding/removing elements to the end */
    ...
    private static void demo6(){
        ...
        Queue<Integer> pq = new PriorityQueue<>(List.of(8,6,1,5,3,4,2,7));
